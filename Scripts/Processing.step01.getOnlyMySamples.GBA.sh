...
vcf=~/runs/eyu8/data/vladScript/PD_ROH/PD.noGBAP1.vcf.gz
output=$BASE_DIR/$2.vcf
bed=$3
sample_list=$4

java -Xmx20g -jar ~/projects/def-grouleau/COMMON/soft/lib/java/GATK/GenomeAnalysisTK-3.8/dist/GenomeAnalysisTK.jar -T SelectVariants -R $REF -V $vcf -o $output -L $bed -sf $sample_list -env -nt 40 --ALLOW_NONOVERLAPPING_COMMAND_LINE_SAMPLES
