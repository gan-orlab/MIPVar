...
my $ANNOVARPATH     = "/lustre03/project/6001220/COMMON/soft/src/pipeline_exome.svn/soft/packages/VarAnnot";
my $HUMANDBPATH     = "/lustre03/project/6004655/COMMUN/data/pipeline.external_data/varannot.humandb"; 
my $CANCERPATH      = "$HUMANDBPATH/Cancer/";
my $CLINVARPATH     = "$HUMANDBPATH/CLINVAR/";
my $DBSNPPATH       = "$HUMANDBPATH/dbSNP/";
my $ENCODEPATH      = "$HUMANDBPATH/Encode.UCSC/";
my $FREQUENCIESPATH = "$HUMANDBPATH/Frequencies";
my $GENANNOPATH     = "$HUMANDBPATH/Genanno/";
my $GENOMETRAXPATH  = "$HUMANDBPATH/GenomeTrax/";
my $BODYMAPPATH     = "$HUMANDBPATH/IlluminaBodyMap2/";
my $MIRNAPATH       = "$HUMANDBPATH/miRNA/";
my $MITOPATH        = "$HUMANDBPATH/Mitochondria/";
my $REPEATPATH      = "$HUMANDBPATH/REPEATS/";
my $SCORESPATH      = "$HUMANDBPATH/Scores";
my $DBNSFPPATH      = "$HUMANDBPATH/Scores/dbNSFP";
my $WG_GERPPATH     = "$HUMANDBPATH/Scores/GERP";
my $GWAVAPATH       = "$HUMANDBPATH/Scores/GWAVA";
my $DBSCSNVPATH     = "$HUMANDBPATH/Scores/dbSCSNV";
my $WGSDANNPATH     = "$HUMANDBPATH/Scores/DANN";
my $WGSCADDPATH     = "$HUMANDBPATH/Scores/CADD";
my $EXACPATH        = "$HUMANDBPATH/Frequencies/ExAC";
my $HRCR1PATH       = "$HUMANDBPATH/Frequencies/HRCR1";
my $CGPATH          = "$HUMANDBPATH/Frequencies/CG";
my $GMEPATH         = "$HUMANDBPATH/Frequencies/GME";
my $GNOMADPATH      = "$HUMANDBPATH/Frequencies/GNOMAD";
my $WGSEIGENPATH    = "$HUMANDBPATH/Scores/WGSEIGEN";
my $WGSFATHMMPATH   = "$HUMANDBPATH/Scores/FATHMM";
my $KAVIARPATH      = "$HUMANDBPATH/Frequencies/Kaviar";
my $RVIS_EXACPATH   = "$HUMANDBPATH/Scores/RVIS_ExAC";
my $REVELPATH       = "$HUMANDBPATH/Scores/REVEL";
my $INTERVARPATH    = "$HUMANDBPATH/INTERVAR";
my $MPC_EXACPATH    = "$HUMANDBPATH/Scores/MPC_ExAC";
my $UORFPATH        = "$HUMANDBPATH/uORF";
