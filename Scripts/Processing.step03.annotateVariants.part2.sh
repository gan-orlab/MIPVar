...
vcf2annovar=/lustre03/project/6004655/COMMUN/runs/eyu8/soft/MIPVar/Scripts/vcf2annovar.pl
...
perl $vcf2annovar -v -i $vcf_dbsnp -b v37 -vc gatk -id $(basename $vcf) --exclude all --include $(printf "%s," $(cat $annotation_list)|sed 's/,$//g') -o $BASE_DIR/$vcf_annovar
